...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/20 14:09:56 by hkuphal           #+#    #+#             */
/*   Updated: 2019/02/22 12:19:16 by hkuphal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				*ft_get_sum_arr(int *n1, int *n2, int m, int diff);
int				*ft_get_prod_arr(int *n1, int *n2, size_t size);
int				*ft_get_pow_arr(int n, int pow, size_t size);
...
char			*ft_strnstr(const char *haystacl, const char *needle,\
							size_t len);
